# CALENDAR.md — 2026 Key Dates

> Personal calendar. One-off dates only. Updated as plans evolve.
...
| 21-22 (Sat-Sun) | Weekend Away | Lake District - Buttermere Circular (Sat), Derwentwater Circuit (Sun) |
...
| Date | Type | Event |
|------|------|-------|
| 1-14 | Holiday | Hiking holiday (destination TBC) |
...
| Date | Type | Event |
|------|------|-------|
| 5 (Sat) | Day Trip | Great Gable Circular - family walk |
...
| Date | Type | Event |
|------|------|-------|
| 8-15 | Holiday | Turkey - Hillside Beach Club with David & Patrina (1 week) |
...
| Date | Type | Event |
|------|------|-------|
| 14-15 | Weekend Away | Cheltenham Races - Paddy Power Gold Cup. Scott & Tom with Steve and the boys. |
...
- Monthly family walks (Jan booked, Feb onwards TBC)
- Other trips/events to be added
